...
wss.on('connection', (socket, request) => {
  ...
  socket.on('message', (raw) => {
    ...
    if (message.type === 'signal') {
      ...
      return safeSend(target.socket, { type: 'signal', from: id, connectionId: message.connectionId, mode: message.mode, allowDirect: message.allowDirect, description: message.description, candidate: message.candidate })
    }
